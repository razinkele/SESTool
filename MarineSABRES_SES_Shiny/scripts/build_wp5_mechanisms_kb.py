...
ARCTIC_MECHANISMS = [
    ...
    # ----- arc_02: Shared public financing of ICES scientific advice -----
    {
        "id": "arc_02_ices_scientific_advice",
        "name": "Shared public financing of ICES scientific advice",
        "cost_profile": "recurring",
        "what_it_funds": "Stock assessments, ecosystem advice, and the long-term shared scientific infrastructure underpinning quota allocation and management decisions in the Arctic Northeast Atlantic. Funded through national contributions and in-kind support from ICES Member Countries, with a top-up contribution from NEAFC's administrative budget.",
        "finance_flow": {
            "payer": ["ICES Member Country governments", "NEAFC (top-up contribution from member assessed contributions)"],
            "receiver": "ICES Secretariat and the network of ~700 marine institutes / 6,000 scientists delivering advice",
            "type": "public",
        },
        "design_parameters": [
            "Costed advisory requests: resource implications and feasibility considered at the request-formulation stage",
            "Stable multi-annual data flows funded through national budgets, not project grants",
            "In-kind contributions (institute scientist time, vessels) recognised alongside cash contributions",
            "Transparent advisory framework principles published (ICES Advice 2020, §1.1)",
        ],
        "evidence_base": [
            "ICES (n.d.) About ICES — institutional structure",
            "ICES (2020) Guide to ICES advisory framework and principles, ICES Advice §1.1",
            "NEAFC (n.d.b.) Finance and administration rules — confirms NEAFC contribution to ICES",
        ],
        "transferable_lessons": [
            "Pooled national financing of shared science survives political shocks better than project-by-project funding",
            "Costing advice at request stage prevents scope creep and aligns demand with supply",
            "In-kind institute contributions multiply the cash budget several-fold and anchor science in member capacity",
        ],
        "applies_to_DAs": ["arctic"],
        "success_metrics": [],
        "risks_and_guardrails": [
            {"risk": "Member states free-ride on contributions or withdraw advisory requests under fiscal pressure",
             "guardrail": "Mandatory assessed contributions formalised in ICES Convention and topped up by NEAFC budget line"},
            {"risk": "Advice scope outpaces funding, eroding quality",
             "guardrail": "Resource-implications screening at the request-formulation stage (per ICES, 2020)"},
        ],
        "use_in_impact_assessment": "Use when scoring any Arctic scenario (S1 No Agreement through S3 Full Agreement) — ICES advice is the foundational science layer all other mechanisms presuppose. Score positively on FF (sustained shared funding) and EE (network effect across 700 institutes); flag as continuity risk if any major contributor exits. Treat as enabling precondition rather than scenario-differentiating instrument.",
        "references": ["MarineSABRES D5.2 Arctic DA, mechanism #2", "ICES (2020) Guide to ICES advisory framework"],
    },
    # ----- arc_03: National financing of NEAFC governance and enforcement -----
    {
        "id": "arc_03_neafc_governance_enforcement",
        "name": "National financing of NEAFC governance and enforcement",
        "cost_profile": "recurring",
        "what_it_funds": "Two-tier public financing: (i) NEAFC Secretariat operations, meetings, and a contribution to ICES via mandatory assessed contributions from Contracting Parties; and (ii) monitoring, control, surveillance, and enforcement activities financed decentrally through national budgets and operational capacity (vessels, observers, inspection at sea).",
        "finance_flow": {
            "payer": ["NEAFC Contracting Parties (national governments: NO, IS, FO, RU, EU, DK-Greenland)"],
            "receiver": "NEAFC Secretariat (centrally) and national fisheries control authorities (decentrally)",
            "type": "public",
        },
        "design_parameters": [
            "Mandatory assessed contributions formula in NEAFC Finance and Administration Rules (not voluntary)",
            "Strict separation: central budget covers governance + ICES top-up; enforcement remains a national line",
            "Reserves maintained at Secretariat level to absorb fiscal shocks (per 2014 Performance Review)",
            "Performance review cycle (independent panel) every ~10 years to recalibrate adequacy",
        ],
        "evidence_base": [
            "NEAFC (n.d.a.) About NEAFC; (n.d.b.) Finance and administration rules",
            "NEAFC (2014) Performance Review of the North East Atlantic Fisheries Commission",
        ],
        "transferable_lessons": [
            "Decentralised enforcement financing is politically sustainable but creates uneven implementation across parties",
            "Central reserves de-risk governance continuity but cannot substitute for national enforcement capacity",
            "Persistent allocation disputes (and unilateral quotas) signal that governance financing alone does not resolve fairness gaps",
        ],
        "applies_to_DAs": ["arctic"],
        "success_metrics": [],
        "risks_and_guardrails": [
            {"risk": "Asymmetric national enforcement capacity creates compliance free-riding",
             "guardrail": "Joint at-sea inspection scheme and harmonised electronic monitoring standards"},
            {"risk": "Unilateral quota declarations during prolonged allocation disputes (per 2014 Performance Review)",
             "guardrail": "Pre-agreed allocation revision triggers and binding dispute resolution within NEAFC framework"},
        ],
        "use_in_impact_assessment": "Use when scoring scenarios that depend on coordinated multi-party enforcement (S2 Partial Agreement, S3 Full Agreement). Score neutral-to-positive on FF (proven multi-decade reliability) but flag downside risk on EE under S1 (No Agreement) where unilateral actions undermine adherence to scientific advice. Pair with compliance and unilateral-quota incident indicators.",
        "references": ["MarineSABRES D5.2 Arctic DA, mechanism #3", "NEAFC (2014) Performance Review"],
    },
    # ----- arc_04: Rights-based quota allocation and transferability -----
    {
        "id": "arc_04_rights_based_quota",
        "name": "Rights-based quota allocation and transferability",
        "cost_profile": "conditional",
        "what_it_funds": "Not a financial transfer scheme but a rights-allocation framework that converts TAC shares into economically valuable, defined harvesting rights held by individuals, companies, vessels, or communities. By making rights exclusive and tradable (where permitted), it generates investment-grade signals, enables longer-term sustainable harvesting decisions, and creates the economic surplus base that cost-recovery (arc_01) and leasing (arc_05) instruments can monetise.",
        "finance_flow": {
            "payer": ["national fisheries authorities allocating quota shares (no direct cash flow)"],
            "receiver": "rights holders (individual fishers, vessel owners, fishing companies, communities)",
            "type": "public",
        },
        "design_parameters": [
            "Clear definition of right scope: where, when, how much, and by whom fishing may occur",
            "Tenure security: multi-year or perpetual rights attract long-term investment behaviour",
            "Distributional safeguards (community quotas, owner-operator clauses) to manage concentration",
            "Coupling with cost-recovery fees so that part of the resource rent accrues to the public (per OECD FSE framework)",
        ],
        "evidence_base": [
            "Abbott, Leonard & Garber-Yonts (2022) Distributional outcomes of rights-based management, PNAS 119(2)",
            "WWF (n.d.) Rights-based management in fisheries — brochure",
            "Hardin (1968) Tragedy of the commons — foundational reasoning",
        ],
        "transferable_lessons": [
            "Secure exclusive rights remove the open-access incentive to overharvest, but do not by themselves guarantee equitable distribution",
            "RBM systems consistently shift surplus toward quota owners; pair with distributional rules upfront, not retroactively",
            "Rights design (lease-allowed vs lease-restricted; transferable vs non-transferable) determines downstream financial mechanism feasibility",
        ],
        "applies_to_DAs": ["arctic"],
        "success_metrics": [],
        "risks_and_guardrails": [
            {"risk": "Quota concentration in few large holders erodes fishing-community livelihoods",
             "guardrail": "Ownership caps, owner-operator requirements, and community quota set-asides"},
            {"risk": "Allocation key disputes (especially under shifting stock distributions) block agreement entirely",
             "guardrail": "Pre-agreed revision triggers tied to ICES distribution evidence; complement with quota leasing (arc_05) for adjustment"},
        ],
        "use_in_impact_assessment": "Use as a precondition for scoring all Arctic agreement scenarios (S2 Partial, S3 Full). Score positively on EC (resource-rent capture potential) and FF (asset-based investment signals); flag distributional-equity risk on social indicators. Treat as the structural backbone that arc_01 fees and arc_05 leasing depend on for traction.",
        "references": ["MarineSABRES D5.2 Arctic DA, mechanism #4", "Abbott et al. (2022) PNAS 119(2)", "WWF RBM brochure"],
    },
    # ----- arc_05: Quota leasing and trading as adjustment mechanism -----
    {
        "id": "arc_05_quota_leasing_trading",
        "name": "Quota leasing and trading as adjustment mechanism",
        "cost_profile": "contingent",
        "what_it_funds": "Acts as a de facto financial instrument allowing economic adjustment between parties without re-opening allocation key negotiations. Quota lessors receive payments from lessees for temporary use of harvesting rights; cross-jurisdictional trades (where permitted) compensate parties as stocks shift across boundaries. Particularly valuable in the Arctic Northeast Atlantic where stock distributions are shifting and allocation disputes are recurrent.",
        "finance_flow": {
            "payer": ["quota lessees (vessel operators or jurisdictions short of quota)"],
            "receiver": "quota lessors (rights holders or jurisdictions with surplus quota)",
            "type": "private",
        },
        "design_parameters": [
            "Clear lease/trade authorisation rules within national allocation systems",
            "Transparency: lease prices and volumes registered to enable market discovery and tax/fee assessment",
            "Annual or in-season lease windows aligned with stock-assessment cycle",
            "Optional cross-jurisdictional trading clauses negotiable bilaterally under NEAFC framework",
        ],
        "evidence_base": [
            "Abbott, Leonard & Garber-Yonts (2022) — quota leasing identified as new payment stream in catch-share systems",
            "WWF (n.d.) Rights-based management — leasing/transfer as flexibility design",
            "MarineSABRES D5.2 Arctic DA — flagged research gap on formal vs informal operation of leasing in this region",
        ],
        "transferable_lessons": [
            "Leasing reduces transaction cost of stock shifts compared with renegotiating the allocation key",
            "Markets work poorly without price-and-volume registries — opacity invites informal/grey trading",
            "Leasing can support cooperation even in the absence of comprehensive allocation agreement, but does not substitute for one",
        ],
        "applies_to_DAs": ["arctic"],
        "success_metrics": [],
        "risks_and_guardrails": [
            {"risk": "Lease markets concentrate quota in absentee owners (rentier dynamic)",
             "guardrail": "Active-use rules, lease-fraction caps, or owner-operator clauses tied to quota right"},
            {"risk": "Informal/cross-border leasing escapes oversight and undermines allocation legitimacy",
             "guardrail": "Mandatory lease registry with NEAFC-level reporting; cross-jurisdictional trades require bilateral protocol"},
        ],
        "use_in_impact_assessment": "Use when scoring scenarios where stock distribution is shifting (a defining Arctic stressor) and where allocation renegotiation is politically blocked — particularly S1 (No Agreement) and S2 (Partial Agreement). Score positively on EE (allocation-flexibility cushion) but flag governance-legitimacy risk if used without registry. Mark as research-gap mechanism — formal vs informal operation in the Arctic NEA needs further empirical study.",
        "references": ["MarineSABRES D5.2 Arctic DA, mechanism #5", "Abbott et al. (2022) PNAS 119(2)"],
    },
    # ----- arc_06: MSC ecolabelling and market-based incentives -----
    {
        "id": "arc_06_msc_ecolabelling",
        "name": "MSC ecolabelling and market-based incentives",
        "cost_profile": "recurring",
        "what_it_funds": "Programme delivery and improvement activities of the Marine Stewardship Council ecolabel — financed through donor contributions and ecolabel licensing fees paid by certified seafood supply-chain actors. Does not fund fisheries management directly; instead, it reinforces compliance and best-practice incentives within rights-based systems by linking access-to-premium-markets to demonstrated sustainability performance.",
        "finance_flow": {
            "payer": ["seafood retailers, processors, and brand owners (ecolabel licensing fees)", "philanthropic and institutional donors"],
            "receiver": "Marine Stewardship Council (programme delivery, certification standards maintenance, fishery improvement activities)",
            "type": "blended",
        },
        "design_parameters": [
            "Independent third-party certification against MSC Fisheries Standard, separating standard-setting from auditing",
            "Chain-of-custody certification linking certified catch through to retail",
            "Conditions and pre-conditions allow time-bound improvement pathways (Fishery Improvement Projects)",
            "Public funding/finances disclosure (per MSC, n.d., Our funding and finances) for credibility",
        ],
        "evidence_base": [
            "Marine Stewardship Council (n.d.) Our funding and finances",
            "MarineSABRES D5.2 Arctic DA — recognised as complementary, not substitute, mechanism",
        ],
        "transferable_lessons": [
            "Market-based labels work best as a layer on top of strong public governance, not as a replacement for it",
            "Premium-market access is a soft incentive — material only where retailers commit to certified-only sourcing",
            "Donor-licensee blended funding model insulates the standard-setter from regulatory capture but creates visible conflict-of-interest narratives that need active management",
        ],
        "applies_to_DAs": ["arctic"],
        "success_metrics": [],
        "risks_and_guardrails": [
            {"risk": "Certification of fisheries with unresolved sustainability concerns dilutes the label's credibility",
             "guardrail": "Conditional certification with binding improvement timelines and independent surveillance audits"},
            {"risk": "Small-scale or community fishers cannot afford certification cost, creating market exclusion",
             "guardrail": "Group certification, FIP pathways, and donor-supported assessment for small fisheries"},
        ],
        "use_in_impact_assessment": "Use as a complementary mechanism when scoring scenarios that already have functional public governance (S2 Partial, S3 Full) — score modest-positive on FF (private finance leverage) and EE (consumer signal). Do not rely on it under S1 (No Agreement) where governance gaps undermine certification credibility. Treat as reinforcement layer to arc_03 enforcement and arc_04 rights-based management.",
        "references": ["MarineSABRES D5.2 Arctic DA, mechanism #6", "MSC (n.d.) Our funding and finances"],
    },
