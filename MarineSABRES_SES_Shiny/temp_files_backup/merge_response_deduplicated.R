#!/usr/bin/env Rscript
# Merge deduplicated response measures translations into translation.json
...
cat("\nLoading deduplicated response measures translations...\n")
new_trans <- fromJSON("response_measures_deduplicated.json", simplifyVector = FALSE)
cat("  - New deduplicated translations:", length(new_trans), "\n")
