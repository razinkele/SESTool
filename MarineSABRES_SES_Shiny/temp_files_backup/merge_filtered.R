#!/usr/bin/env Rscript
# Merge filtered unique translations into translation.json
...
cat("\nLoading filtered unique translations...\n")
new_trans <- fromJSON("filtered_missing_translations.json", simplifyVector = FALSE)
