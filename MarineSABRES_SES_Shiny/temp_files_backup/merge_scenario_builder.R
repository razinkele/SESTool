#!/usr/bin/env Rscript
# Merge scenario builder unique translations into translation.json
...
cat("\nLoading scenario builder unique translations...\n")
new_trans <- fromJSON("scenario_builder_unique_translations.json", simplifyVector = FALSE)
...
cat("\n✓ SUCCESS! Scenario builder translations merged.\n")
