...
**Version**: 1.12.0 | **R Version**: >= 4.4.1 | **Framework**: bs4Dash + shiny.i18n
...
└── tests/testthat/       # 90 test files, ~7,280 assertions passing (incl. 172 WP5 Phase 1; 21/21 *_module.R covered)
```
...
### Surfacing
The reference pane in `modules/response_module.R` (tab 6 "Linked WP5 mechanisms") shows DA-relevant mechanisms keyed off the project's `data$metadata$da_site`.
